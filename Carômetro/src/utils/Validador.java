...
// validações nos campos da inverface gráfica
	...
	public void insertString(int ofs, String str, AttributeSet a) throws BadLocationException {
		if (getLength() + str.length() <= limite) { // verificando se o textNome é menor ou maior que o estabelecido
													// pela variavel limite
